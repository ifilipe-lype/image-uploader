    ...
    return (
        <div className="w-full max-w-md flex flex-col items-center justify-center bg-white p-8 splash-shadow rounded-xl">
            ...
            <div className="w-full p-1 rounded-lg flex-nowrap border border-gray-7 bg-gray-1 flex items-center justify-between">
                ...
                <span className="text-xs pl-2 w-8/12 overflow-hidden text-left whitespace-nowrap text-gray-2 overflow-ellipsis">{imgSrc}</span>
                <button onClick={copyUrl} className="bg-blue1 px-4 py-2 text-white rounded-lg text-sm font-normal flex-nowrap">
                    Copy Link
                </button>
            </div>

            <div className="mt-4 text-xs md:text-sm text-blue1">
